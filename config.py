# -*- coding: utf-8 -*-
"""config.py -- Phantom Edge Bot ZigZag."""
import os
...
class Config:
    ...
    # ZigZag
    zz_deviation:  float = 0.5   # % minima para nuevo swing
    atr_period:    int   = 14
    atr_mult:      float = 1.5   # fallback SL si estructura muy lejos
    rr:            float = 2.5
    ...
    # Unused but kept for compat with strategy signature
    pivot_len:     int   = 3
    adx_period:    int   = 14
    adx_min:       float = 0.0   # 0 = disabled
